CREATE TABLE [fct_v1].[ProductionOrder] (
    ...
    [ItemProductionQuantity] INT CONSTRAINT [DF__Productio__ItemP__348B724F] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_ProductionOrder] PRIMARY KEY CLUSTERED ([CompanyID] ASC, [NK_ProductionOrderNumber] ASC, [NK_ProductionOrderLineNumber] ASC, [ADF_FactSource] ASC)
);
