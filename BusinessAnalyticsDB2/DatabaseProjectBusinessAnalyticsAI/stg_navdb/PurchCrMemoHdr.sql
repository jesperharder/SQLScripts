CREATE TABLE [stg_navdb].[PurchCrMemoHdr] (
    ...
    [Vendor Cr_ Memo No_]          VARCHAR (20)       NOT NULL,
    ...
    [Prepmt_ Cr_ Memo No_ Series]  VARCHAR (10)       NOT NULL,
    ...
    [BAS Adjustment]               TINYINT            NOT NULL,
    [Adjustment Applies-to]        VARCHAR (20)       NOT NULL,
    ...
    [BizTalk Purchase Credit Memo] TINYINT            NOT NULL,
    ...
    CONSTRAINT [PK_stg_bc_PurchCrMemoHdr] PRIMARY KEY CLUSTERED ([CompanyID] ASC, [No_] ASC)
);
