CREATE TABLE [stg_navdb].[SalesCrMemoLine] (
    ...
    [PipelineName]                   NVARCHAR (200)     CONSTRAINT [DF_SalesCrMemoLine_PipelineName] DEFAULT ('Default') NOT NULL,
    [PipelineRunId]                  NVARCHAR (36)      CONSTRAINT [DF_SalesCrMemoLine_PipelineRunId] DEFAULT ('00000000-0000-0000-0000-000000000000') NOT NULL,
    [PipelineTriggerTime]            DATETIMEOFFSET (0) CONSTRAINT [DF_SalesCrMemoLine_PipelineTriggerTime] DEFAULT (sysdatetimeoffset()) NOT NULL,
    [CompanyID]                      INT                NOT NULL,
    CONSTRAINT [PK_stg_navdb_SalesCrMemoLine] PRIMARY KEY CLUSTERED ([CompanyID] ASC, [Document No_] ASC, [Line No_] ASC) WITH (DATA_COMPRESSION = ROW)
);


GO

CREATE NONCLUSTERED INDEX [NIX_stg_navdb_SalesCrMemoLine_Type_VATProdPostingGroup_PostingDate_WithIncluded]
    ON [stg_navdb].[SalesCrMemoLine]([Type] ASC, [VAT Prod_ Posting Group] ASC, [Posting Date] ASC)
