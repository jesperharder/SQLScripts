CREATE TABLE [stg_navdb].[SalesCrMemoHeader] (
    ...
    [BizTalk Sales Credit Memo]      TINYINT            NOT NULL,
    ...
    CONSTRAINT [PK_stg_navdb_SalesCrMemoHeader] PRIMARY KEY CLUSTERED ([CompanyID] ASC, [No_] ASC) WITH (DATA_COMPRESSION = ROW)
);
