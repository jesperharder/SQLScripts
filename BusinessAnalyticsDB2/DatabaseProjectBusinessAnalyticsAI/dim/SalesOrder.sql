CREATE TABLE [dim].[SalesOrder] (
    ...
    CONSTRAINT [PK_dim_SalesOrder] PRIMARY KEY CLUSTERED ([SalesOrderKey] ASC) WITH (DATA_COMPRESSION = ROW),
    CONSTRAINT [UQ_dim_SalesOrder] UNIQUE NONCLUSTERED ([CompanyID] ASC, [SalesOrderNumber] ASC) WITH (DATA_COMPRESSION = ROW)
);
