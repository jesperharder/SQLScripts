CREATE TABLE [dim].[BudgetVersion] (
    ...
    CONSTRAINT [PK_dim_BudgetVersion] PRIMARY KEY CLUSTERED ([BudgetVersionKey] ASC) WITH (DATA_COMPRESSION = ROW),
    CONSTRAINT [UQ_dim_BudgetVersion] UNIQUE NONCLUSTERED ([BudgetVersion] ASC) WITH (DATA_COMPRESSION = ROW)
);
