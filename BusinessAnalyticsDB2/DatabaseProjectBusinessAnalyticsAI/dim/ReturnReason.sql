CREATE TABLE [dim].[ReturnReason] (
    ...
    CONSTRAINT [PK_dim_ReturnReason] PRIMARY KEY CLUSTERED ([ReturnReasonKey] ASC) WITH (DATA_COMPRESSION = ROW),
    CONSTRAINT [UQ_dim_ReturnReason] UNIQUE NONCLUSTERED ([ReturnReasonCompanyID] ASC, [ReturnReasonCode] ASC) WITH (DATA_COMPRESSION = ROW)
);
