CREATE TABLE [dim].[AdHoc] (
    ...
    CONSTRAINT [PK_dim_AdHoc] PRIMARY KEY CLUSTERED ([AdHocKey] ASC) WITH (DATA_COMPRESSION = ROW),
    CONSTRAINT [UQ_dim_AdHoc] UNIQUE NONCLUSTERED ([CompanyID] ASC, [Dimension Code] ASC, [AdHocCode] ASC) WITH (DATA_COMPRESSION = ROW)
);
