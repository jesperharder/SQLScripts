CREATE TABLE [dim].[Employee] (
    ...
    CONSTRAINT [PK_dim_Employee] PRIMARY KEY CLUSTERED ([EmployeeKey] ASC) WITH (DATA_COMPRESSION = ROW),
    CONSTRAINT [UQ_dim_Employee] UNIQUE NONCLUSTERED ([CompanyID] ASC, [Dimension Code] ASC, [EmployeeCode] ASC) WITH (DATA_COMPRESSION = ROW)
);
