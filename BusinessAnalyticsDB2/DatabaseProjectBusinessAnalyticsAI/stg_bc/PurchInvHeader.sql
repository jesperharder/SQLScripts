CREATE TABLE [stg_bc].[PurchInvHeader] (
    ...
    [Draft Invoice SystemId]       NVARCHAR (36)      NOT NULL,
    ...
    CONSTRAINT [PK_stg_bc_PurchInvHeader] PRIMARY KEY CLUSTERED ([CompanyID] ASC, [No_] ASC) WITH (DATA_COMPRESSION = ROW)
);
