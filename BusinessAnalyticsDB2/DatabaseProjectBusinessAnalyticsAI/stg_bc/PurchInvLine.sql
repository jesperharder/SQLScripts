CREATE TABLE [stg_bc].[PurchInvLine] (
    ...
    [IC Cross-Reference No_]         NVARCHAR (50)      NOT NULL,
    ...
    [Overhead Rate]                  DECIMAL (18)       NOT NULL,
    ...
    CONSTRAINT [PK_stg_bc_PurchInvLine] PRIMARY KEY CLUSTERED ([CompanyID] ASC, [Document No_] ASC, [Line No_] ASC) WITH (DATA_COMPRESSION = ROW)
);
