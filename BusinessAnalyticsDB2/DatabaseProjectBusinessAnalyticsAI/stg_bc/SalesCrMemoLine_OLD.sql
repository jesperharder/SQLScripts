CREATE TABLE [stg_bc].[SalesCrMemoLine_OLD] (
    ...
    CONSTRAINT [PK_stg_bc_SalesCrMemoLine] PRIMARY KEY CLUSTERED ([CompanyID] ASC, [Document No_] ASC, [Line No_] ASC) WITH (DATA_COMPRESSION = ROW)
);
