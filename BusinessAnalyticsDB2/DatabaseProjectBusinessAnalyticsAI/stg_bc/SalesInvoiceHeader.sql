CREATE TABLE [stg_bc].[SalesInvoiceHeader] (
    ...
    [Payment Instructions]           VARBINARY (MAX)    NULL,
    ...
    CONSTRAINT [PK_stg_bc_SalesInvoiceHeader] PRIMARY KEY CLUSTERED ([CompanyID] ASC, [No_] ASC) WITH (DATA_COMPRESSION = ROW)
);
