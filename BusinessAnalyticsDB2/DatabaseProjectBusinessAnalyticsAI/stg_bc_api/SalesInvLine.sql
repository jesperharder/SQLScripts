...
CREATE NONCLUSTERED INDEX [IX_SalesInvLine_Document]
    ...
    INCLUDE([lineNo], [typeInt], [no], [variantCode], [locationCode], [quantity], [amount], [amountIncludingVAT], [shipmentDate], [yearCodeText], [systemModifiedAt]);
...
CREATE NONCLUSTERED INDEX [IX_SalesInvLine_Item]
    ...
    INCLUDE([documentNo], [lineNo], [typeInt], [locationCode], [quantity], [amount], [amountIncludingVAT], [yearCodeText], [systemModifiedAt]);
...
CREATE NONCLUSTERED INDEX [IX_SalesInvLine_SystemModifiedAt]
    ...
    INCLUDE([documentNo], [lineNo], [typeInt], [no], [quantity], [amount], [amountIncludingVAT], [yearCodeText]);
