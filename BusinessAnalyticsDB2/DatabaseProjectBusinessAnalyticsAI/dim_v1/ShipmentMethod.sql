CREATE TABLE [dim_v1].[ShipmentMethod] (
    ...
    CONSTRAINT [PK_dim_ShipmentMethod] PRIMARY KEY CLUSTERED ([ShipmentMethodKey] ASC),
    CONSTRAINT [UQ_dim_ShipmentMethod] UNIQUE NONCLUSTERED ([ShipmentMethodCompanyID] ASC, [ShipmentMethodCode] ASC)
);
