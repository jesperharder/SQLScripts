CREATE TABLE [dim_v1].[Team] (
    ...
    CONSTRAINT [PK_dim_Team] PRIMARY KEY CLUSTERED ([TeamKey] ASC),
    CONSTRAINT [UQ_dim_Team] UNIQUE NONCLUSTERED ([TeamCompanyID] ASC, [TeamCode] ASC, [TeamPersonCode] ASC)
);
