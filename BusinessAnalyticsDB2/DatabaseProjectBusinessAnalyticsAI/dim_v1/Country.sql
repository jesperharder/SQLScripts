CREATE TABLE [dim_v1].[Country] (
    ...
    CONSTRAINT [PK_dim_Country] PRIMARY KEY CLUSTERED ([CountryKey] ASC),
    CONSTRAINT [UQ_dim_Country] UNIQUE NONCLUSTERED ([Dimension Code] ASC, [CountryCode] ASC)
);
