CREATE TABLE [dim_v1].[Workcenter] (
    ...
    CONSTRAINT [PK_dim_Workcenter] PRIMARY KEY CLUSTERED ([WorkcenterKey] ASC),
    CONSTRAINT [UQ_dim_Workcenter] UNIQUE NONCLUSTERED ([WorkcenterCompanyID] ASC, [WorkcenterNumber] ASC)
);
