CREATE TABLE [dim_v1].[Maintainance] (
    ...
    CONSTRAINT [PK_dim_Maintainance] PRIMARY KEY CLUSTERED ([MaintainanceKey] ASC),
    CONSTRAINT [UQ_dim_Maintainance] UNIQUE NONCLUSTERED ([CompanyID] ASC, [Dimension Code] ASC, [MaintainanceCode] ASC)
);
