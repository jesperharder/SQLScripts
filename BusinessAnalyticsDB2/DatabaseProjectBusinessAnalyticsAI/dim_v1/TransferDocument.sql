CREATE TABLE [dim_v1].[TransferDocument] (
    ...
    CONSTRAINT [PK_TransferDocument] PRIMARY KEY CLUSTERED ([TransferDocumentKey] ASC),
    CONSTRAINT [UQ_TransferDocument] UNIQUE NONCLUSTERED ([CompanyID] ASC, [TransferDocumentNumber] ASC, [TransferDocumentLineNumber] ASC)
);


GO

EXECUTE sp_addextendedproperty @name = N'UnknownEntityName', @value = N'TransferDocument', @level0type = N'SCHEMA', @level0name = N'dim_v1', @level1type = N'TABLE', @level1name = N'TransferDocument';
