...
EXECUTE sp_addextendedproperty @name = N'UnknownEntityName', @value = N'Geography', @level0type = N'SCHEMA', @level0name = N'dim_v1', @level1type = N'TABLE', @level1name = N'Geography';
