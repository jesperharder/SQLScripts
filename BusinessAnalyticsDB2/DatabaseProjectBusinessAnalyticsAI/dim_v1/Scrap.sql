CREATE TABLE [dim_v1].[Scrap] (
    ...
    CONSTRAINT [PK_dim_Scrap] PRIMARY KEY CLUSTERED ([ScrapKey] ASC),
    CONSTRAINT [UQ_dim_Scrap] UNIQUE NONCLUSTERED ([ScrapCompanyID] ASC, [ScrapCode] ASC)
);
