CREATE TABLE [dim_v1].[Routing] (
    ...
    CONSTRAINT [PK_dim_Routing] PRIMARY KEY CLUSTERED ([RoutingKey] ASC),
    CONSTRAINT [UQ_dim_Routing] UNIQUE NONCLUSTERED ([RoutingCompanyID] ASC, [RoutingNumber] ASC)
);
