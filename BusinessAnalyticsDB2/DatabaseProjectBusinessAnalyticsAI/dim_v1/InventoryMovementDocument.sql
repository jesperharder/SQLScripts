CREATE TABLE [dim_v1].[InventoryMovementDocument] (
    ...
    [InventoryUserId]                  NVARCHAR (50)  NULL,
    [InventoryNoSeries]                NVARCHAR (20)  NULL,
    ...
    CONSTRAINT [PK_dim_InventoryMovementDocument] PRIMARY KEY CLUSTERED ([InventoryMovementDocumentKey] ASC),
    CONSTRAINT [UQ_dim_InventoryMovementDocument] UNIQUE NONCLUSTERED ([CompanyID] ASC, [InventoryMovementDocumentNumber] ASC, [InventoryMovementCause] ASC, [ItemLedgerEntryType] ASC, [InventoryPostingDate] ASC, [InventoryUserId] ASC, [InventoryNoSeries] ASC)
);
