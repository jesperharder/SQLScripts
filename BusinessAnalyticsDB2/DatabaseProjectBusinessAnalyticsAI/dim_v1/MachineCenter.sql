CREATE TABLE [dim_v1].[MachineCenter] (
    ...
    CONSTRAINT [PK_dim_MachineCenter] PRIMARY KEY CLUSTERED ([MachineCenterKey] ASC),
    CONSTRAINT [UQ_dim_MachineCenter] UNIQUE NONCLUSTERED ([MachineCenterCompanyID] ASC, [MachineCenterNumber] ASC)
);
