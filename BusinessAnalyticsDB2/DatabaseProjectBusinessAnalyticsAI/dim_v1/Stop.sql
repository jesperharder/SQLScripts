CREATE TABLE [dim_v1].[Stop] (
    ...
    CONSTRAINT [PK_dim_Stop] PRIMARY KEY CLUSTERED ([StopKey] ASC),
    CONSTRAINT [UQ_dim_Stop] UNIQUE NONCLUSTERED ([StopCompanyID] ASC, [StopCode] ASC)
);
